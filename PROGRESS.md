...
- [~] **Phase 8 — Complete the fast Rust core** (mirror every Python capability in Rust; value-order,
  ...
  - [ ] **8.3 ratchet session AEAD** (port ratchet_aead.py — HMAC chain over the committing AEAD).
